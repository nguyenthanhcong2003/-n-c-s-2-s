                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="front/img/user/{{ \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatars.jpg'}}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="front/img/user/{{ \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatars.jpg'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
